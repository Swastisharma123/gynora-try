    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="grid grid-cols-3 gap-3">
        <Button
          asChild
          variant="outline"
          className="h-16 flex-col space-y-2 border-purple-200"
        >
          <a
            href="https://drive.google.com/file/d/1k6iVJ3-Y4fmzl6AJmz-wPoIVvJrKSw9F/view?usp=sharing"
            target="_blank"
        ...
        <Button variant="outline" className="h-16 flex-col space-y-2 border-purple-200">
          ...
          <span className="text-xs">Email Doctor</span>
        </Button>
      </div>
